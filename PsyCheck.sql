...
-- Relatório 2 com Cursor  medico e diagnostico--
DECLARE
   -- Declaração de variáveis para cursor
   v_cod_medico         NUMBER;
   v_crp                VARCHAR2(20);
...
BEGIN
   ...
   LOOP
      ...
      DBMS_OUTPUT.PUT_LINE('Observação: ' || v_observacao);
      DBMS_OUTPUT.PUT_LINE('Segmento de Ação: ' || v_segmento_acao);
      DBMS_OUTPUT.PUT_LINE('Código da Triagem: ' || v_triagem_cod_triagem);
      DBMS_OUTPUT.PUT_LINE('----------------------------------------');
   END LOOP;
END;
/
